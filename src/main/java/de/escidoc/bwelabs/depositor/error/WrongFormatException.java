...
/**
 * The WrongFormatException is used to indicate that a format of the provided resource is wrong.
 * 
 * @author ROF
 * 
 */
public class WrongFormatException extends ApplicationException {
    ...
    private static final long serialVersionUID = 9019834862324891502L;
